...
```
atest SdvSampleDiagCommunicationTest
```

### CATBox

```
NOTIFY_AS_NATIVE=0.0.0.0:6520,0.0.0.0:6521 ./tools/catbox-tradefed run commandAndExit sdv-sample-diag-communication-test --{device1}serial 0.0.0.0:6520 --{device2}serial 0.0.0.0:6521
```


## CI/CD execution

- Name: `sdv/sample/diag_communication_test`