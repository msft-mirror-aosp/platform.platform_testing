...
# Sample: CommStack - One VM - Ping-Pong Notifications Latency Test
...
```shell
atest SdvSampleCommStackOneVMPingPongTest
```

### CATBox

```shell
NOTIFY_AS_NATIVE=0.0.0.0:6520 ./tools/catbox-tradefed run commandAndExit sdv-sample-comm-stack-one-vm-ping-pong-test --{device1}serial 0.0.0.0:6520
```
