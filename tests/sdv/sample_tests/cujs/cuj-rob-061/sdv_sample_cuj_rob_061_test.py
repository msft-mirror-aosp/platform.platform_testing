...
class SdvSampleCujRob061Test(
    ...
    def test_observe_after_observer_kill(self, _number):
        self.log_enter()
        ...
        self.transition_bundle_lifecycle(self.bar_bundle, LifecycleTransition.DESTROYED)

        # THEN Bar receives no new messages.
        self.verify_no_new_message_received(self.bar_bundle)

        # AND WHEN Bar is started again.
        self.transition_bundle_lifecycle(self.bar_bundle, LifecycleTransition.STARTED)
