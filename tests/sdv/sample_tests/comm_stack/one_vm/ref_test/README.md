...
# Sample: CommStack - Reference Test
...
Read [SDV Testing instructions](/platform_testing/tests/sdv/README.md) for detailed information.

### Mobly

```shell
atest SdvSampleCommStackOneVMTest
```

### CATBox

```shell
NOTIFY_AS_NATIVE=0.0.0.0:6520 ./tools/catbox-tradefed run commandAndExit sdv-sample-comm-stack-one-vm-test --{device1}serial 0.0.0.0:6520
```

## CI/CD execution

- Name: `sdv/sample/comm_stack_test`
