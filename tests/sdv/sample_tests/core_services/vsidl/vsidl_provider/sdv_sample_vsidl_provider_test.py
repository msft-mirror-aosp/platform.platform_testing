...
class SdvSampleVsidlProviderTest(
    ...
    APEX_WITH_PER_BUNDLE_CONFIG_FILE = 'com.sdv.google.sample.vsidl_provider.apex_with_per_bundle_config_file'
    APEX_WITH_SHARED_CONFIG_FILE = 'com.sdv.google.sample.vsidl_provider.apex_with_shared_config_file'
