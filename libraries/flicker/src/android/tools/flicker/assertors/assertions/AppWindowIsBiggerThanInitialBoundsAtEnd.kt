...
/**
 * Checks that the app window is bigger than the initial desktop mode task bounds at the end of the
 * test.
 */
class AppWindowIsBiggerThanInitialBoundsAtEnd(private val component: ComponentTemplate) :
    ...
    override fun doEvaluate(scenarioInstance: ScenarioInstance, flicker: FlickerTest) {
        flicker.assertLayersEnd {
            ...
            val initialBounds = Rect(0, 0, desiredWidth.toInt(), desiredHeight.toInt())
            ...
            initialBounds.offset(xOffset, yOffset)

            visibleRegion(component.get(scenarioInstance)).notSmallerThan(Region(initialBounds))
        }
    }
}
