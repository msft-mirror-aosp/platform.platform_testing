...
"""
SDV Update Manager Agent System Prepare Suspend Reboot Resume Test

Check that if a VM is rebooted while in the PREPARE_SUSPEND_COMPLETE that the update can be resumed successfully.
"""
from sdv_test_fw.test_execution import sdv_base_test, sdv_test_runner
from sdv_test_fw.update.update_manager_base_class import UpdateManagerBaseClass, InterruptAction


class SdvE2EUMSystemPrepareSuspendRebootResumeTest(sdv_base_test.SdvBaseTestClass, UpdateManagerBaseClass):
    ...
    def test_system_prepare_suspend_reboot_resume(self):
