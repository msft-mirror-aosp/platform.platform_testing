...
# Sample: SDV MultiVD Vsock communication sample
...
```
atest SdvSampleMultivdVsockTest
```

### CATBox

```
NOTIFY_AS_NATIVE=0.0.0.0:6520,0.0.0.0:6521 ./tools/catbox-tradefed run commandAndExit sdv-sample-multivd-vsock-test --{device1}serial 0.0.0.0:6520 --{device2}serial 0.0.0.0:6521
```
