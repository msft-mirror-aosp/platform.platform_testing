...
cvd create \
  ...
  --extra_kernel_cmdline=" \
    androidboot.sdv.orchestrator_config_path=/etc/orch/cuj23_vm_orch.config"
```
...
NOTIFY_AS_NATIVE=0.0.0.0:6520,0.0.0.0:6521 \
    catbox-tradefed run commandAndExit sdv-sample-cuj-core-23-test \
    --{device1}serial 0.0.0.0:6520 --{device2}serial 0.0.0.0:6521
```

## CI/CD execution

- Name: `sdv/sample/core_cuj23_test`
