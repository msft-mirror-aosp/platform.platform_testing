...
# Sample: CUJ-ROB-051-IVI

## Sample

This test automates the [CUJ-ROB-051](/system/software_defined_vehicle/samples/cujs/cuj-rob-051/README.md) for an IVI device.
...
```bash
atest SdvLongRunningCujRob051IviTest
```
...
NOTIFY_AS_NATIVE=0.0.0.0:6520,0.0.0.0:6521 catbox-tradefed run commandAndExit \
    sdv-long-running-cuj-rob-051-ivi-test \
    --{device1}serial 0.0.0.0:6520 --{device2}serial 0.0.0.0:6521
```

## CI/CD execution

- Name: `sdv/long_running/cuj_rob_051_ivi`
