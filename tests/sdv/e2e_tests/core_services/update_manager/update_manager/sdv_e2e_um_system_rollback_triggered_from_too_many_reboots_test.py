...
"""
SDV Update Manager Agent System Rollback Triggered From Too Many Reboots Test

Check that a system update that is rebooted too many times during the activation stage without sending a Commit() request is rolled back.
"""
from sdv_test_fw.test_execution import sdv_base_test, sdv_test_runner
from sdv_test_fw.update.update_manager_base_class import get_opposite_slot, UpdateManagerBaseClass


class SdvE2EUMSystemRollbackTriggeredFromTooManyRebootsTest(sdv_base_test.SdvBaseTestClass, UpdateManagerBaseClass):
    ...
    def test_system_rollback_triggered_from_too_many_reboots(self):
        ...
        self.assert_in_status("UpdateEngineError", status_text=status)
