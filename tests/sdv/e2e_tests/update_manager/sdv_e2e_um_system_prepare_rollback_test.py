...
"""
SDV Update Manager Agent System Prepare Rollback Test

Check that the a rollback during the PREPARE_COMPLETE state for a system update succeeds.
"""
from sdv_test_fw.test_execution import sdv_base_test, sdv_test_runner
from sdv_test_fw.update.update_manager_base_class import UpdateManagerBaseClass


class SdvE2EUMSystemPrepareRollbackTest(sdv_base_test.SdvBaseTestClass, UpdateManagerBaseClass):
    ...
    def test_system_prepare_rollback(self):
