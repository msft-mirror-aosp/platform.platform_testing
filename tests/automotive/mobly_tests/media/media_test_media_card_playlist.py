...
class MediaCardPlaylistRendering(bluetooth_base_test.BluetoothBaseTest):
    ...
    def test_playlist_rendering(self):
        ...
        self.discoverer.mbs.openMediaCardPlayList()
        self.discoverer.mbs.clickOnSongFromMediaCardPlaylist(2)
        asserts.assert_true(self.media_utils.is_song_playing_on_hu, 'Song is not playing',
