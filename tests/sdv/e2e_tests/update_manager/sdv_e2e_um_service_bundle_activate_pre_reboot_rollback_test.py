...
"""
SDV Update Manager Agent Service Bundle Activate Pre Reboot Rollback Test

Check that the a rollback during the ACTIVATE_PRE_REBOOT_COMPLETE state for a service bundle update succeeds.
"""
from sdv_test_fw.test_execution import sdv_base_test, sdv_test_runner
from sdv_test_fw.update.update_manager_base_class import UpdateManagerBaseClass


class SdvE2EUMServiceBundleActivatePreRebootRollbackTest(sdv_base_test.SdvBaseTestClass, UpdateManagerBaseClass):
    ...
    def test_service_bundle_activate_pre_reboot_rollback(self):
