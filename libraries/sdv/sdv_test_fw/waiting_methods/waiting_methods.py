...
class WaitingMethods:
    ...
    def wait_for_true(
        ...
        *args,
        ...
        Args:
            func: The function to call (functiona should return true/false).
            *args: arguments, passed to function.
            timeout: The maximum time in seconds to wait for a non-None return.
              Avoid increasing this unless absolutely necessary.
    ...
    def __grep_expected_result(
        sdv_device, grep_text, expected_result=None, logcat_args=None, grep_args=None
    ):
        logcat_result = sdv_device.grep_from_logcat(grep_text, logcat_args, grep_args)
    ...
    def wait_and_verify_expected_logs(
        ...
        WaitingMethods.wait_for_true(
            WaitingMethods.__grep_expected_result,
            sdv_device,
            grep_text,
            expected_result,
            logcat_args,
