...
class BluetoothMediaStatusOnMediaCenter(bluetooth_base_test.BluetoothBaseTest):
    ...
    def test_media_status_on_media_center(self):
        ...
        for i in range(0, 2):
            ...
            asserts.assert_true(
                self.call_utils.is_connect_to_bluetooth_label_visible_on_bluetooth_audio_page(),
                "Connect to Bluetooth Label is not visible")
            ...
            asserts.assert_false(
                self.call_utils.is_connect_to_bluetooth_label_visible_on_bluetooth_audio_page(),
                "Connect to Bluetooth Label is visible")
