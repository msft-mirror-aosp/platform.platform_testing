...
# Sample: CUJ-ROB-050-IVI

## Sample

This test automates the [CUJ-ROB-050](/system/software_defined_vehicle/samples/cujs/cuj-rob-050/README.md) for an IVI device.
...
```bash
atest SdvLongRunningCujRob050IviTest
```
...
NOTIFY_AS_NATIVE=0.0.0.0:6520,0.0.0.0:6521 catbox-tradefed run commandAndExit \
    sdv-long-running-cuj-rob-050-ivi-test \
    --{device1}serial 0.0.0.0:6520 --{device2}serial 0.0.0.0:6521
```

## CI/CD execution

- Name: `sdv/long_running/cuj_rob_050_ivi`
