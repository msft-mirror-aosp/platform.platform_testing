...
This test automates the [CUJ-ROB-030](/vendor/google_testing/software_defined_vehicle/tests/sample_tests/cujs/cuj-rob-30/README.md) for an IVI device.
...
```bash
atest SdvLongRunningCujRob030IviTest
```
