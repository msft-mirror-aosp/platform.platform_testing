...
SINGLE_VM_QUERY_BASE_TEMPLATE = f"""
--------------- PARAMETER VIEW ---------------
...
CREATE VIEW cpu_count AS SELECT COUNT(DISTINCT cpu) AS num_cpus FROM sched;
...
USING SPAN_JOIN(sched PARTITIONED cpu, interval_bounds);
