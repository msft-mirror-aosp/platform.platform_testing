...
class SdvCujCore22OneVMTest(sdv_base_test.SdvBaseTestClass):
    SAMPLES_LOGCAT_ARGS = "*:F com_sdv_google_sample_foo_ServiceBundleFoo_instance:V com_sdv_google_sample_bar_ServiceBundleBar_instance:V SdvServiceManagerServer:*"
