...
public class GuestMicrophoneOnStatusBarTest {
    ...
    private static final String LOG_TAG = GuestMicrophoneOnStatusBarTest.class.getSimpleName();

    public GuestMicrophoneOnStatusBarTest() {
    ...
    @Test
    public void testMicrophoneInGuestProfile() throws Exception {
