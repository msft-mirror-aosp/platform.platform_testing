...
class BluetoothPerformanceBaseTest(bluetooth_base_test.BluetoothBaseTest):
  ...
  def setup_test(self):
    ...
    try:
      ...
      logging.error(f'Failed to disconnect bluetooth profiles before test iterations')
  ...
  def connection_test_process_per_iteration_metrics(self, metrics):
  ...
  def connection_test_process_per_test_metrics(self, metrics):
