...
/**
 * Android Unit tests for {@link PerfettoTracingBeforeTestStrategy}.
 *
 * <p>To run: atest
 * CollectorDeviceLibTest:android.device.collectors.PerfettoTracingBeforeTestStrategyTest.
 */
@RunWith(AndroidJUnit4.class)
public class PerfettoTracingBeforeTestStrategyTest {
    ...
    private PerfettoTracingBeforeTestStrategy initStrategy(Bundle b) {
        PerfettoTracingBeforeTestStrategy strategy =
                spy(
    ...
    @Test
    public void testPerfettoTraceOnTestStart() {
        Bundle b = new Bundle();
    ...
    @Test
    public void testTwoIterations_onlySecondIsAllowed_collectsTraceOnlyBeforeTheSecond() {
        Bundle b = new Bundle();
