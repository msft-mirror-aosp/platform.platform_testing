...
# Sample: Service Bundle Lifecycle Test
...
```bash
atest SdvSampleServiceBundleLifecycleTest
```
...
NOTIFY_AS_NATIVE=0.0.0.0:6520 ./tools/catbox-tradefed run commandAndExit \
    sdv-sample-service-bundle-lifecycle-test \
    --{device1}serial 0.0.0.0:6520
```

## CI/CD execution

-   Name: `sdv/sample/service_bundle_lifecycle_test`
