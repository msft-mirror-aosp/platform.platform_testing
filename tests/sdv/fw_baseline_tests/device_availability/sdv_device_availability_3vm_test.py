...
"""SDV Three Devices Availability Test"""
...
class SdvThreeDevicesAvailabilityTest(
    ...
    def test_three_devices_availability(self):
        ...
        # Check Availability of Device 3
        self.verify_device_online(self.sdv_device3)
        self.verify_boot_completed(self.sdv_device3)
