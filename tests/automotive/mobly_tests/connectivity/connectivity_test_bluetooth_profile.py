...
class BluetoothProfiles(bluetooth_base_test.BluetoothBaseTest):
    ...
    def test_bluetooth_profiles(self):
        ...
        bt_hfp_status_txt = self.call_utils.get_bt_profile_status_using_adb_command(self.discoverer,
                                                                                    constants.BLUETOOTH_HFP)
        ...
        bt_map_status = self.call_utils.get_bt_profile_status_using_adb_command(self.discoverer,
                                                                                constants.BLUETOOTH_MAP)
        ...
        bt_avrcp_status = self.call_utils.get_bt_profile_status_using_adb_command(self.discoverer,
                                                                                  constants.BLUETOOTH_AVRCP)
