...
```
atest SdvSampleApexDiscoveryTest
```

### CATBox

```
NOTIFY_AS_NATIVE=0.0.0.0:6520 ./tools/catbox-tradefed run commandAndExit sdv-sample-apex-discovery-test --{device1}serial 0.0.0.0:6520
```

## CI/CD execution

- Name: `sdv/sample/apex_discovery_test`