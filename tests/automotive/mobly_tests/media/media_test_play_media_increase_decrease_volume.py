...
class MediaVolumeTest(bluetooth_base_test.BluetoothBaseTest):
    ...
    def test_media_is_song_playing(self):
        ...
        low_media_sound_level = self.discoverer.mbs.setMediaSoundLevelLow()
        high_media_sound_level = self.discoverer.mbs.setMediaSoundLevelHigh()
        self.discoverer.mbs.openSoundPaletteOnStatusBar()
