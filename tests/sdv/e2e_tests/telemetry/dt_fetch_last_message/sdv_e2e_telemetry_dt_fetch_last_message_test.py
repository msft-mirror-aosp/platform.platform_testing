...
class SdvE2ETelemetryDtFetchLastMessageTest(
    ...
    def run_test(self, publisher_device):
        ...
        if publisher_device == self.sdv_device1:
            asserts.assert_equal(
                [
                    (
                        (
                            mc1_all_reports_flmtrue[i][0]['payload'].value,
                            mc1_all_reports_flmtrue[i][0]['payload'].HasField(
                                'value'
                            ),
                        ),
                        (
                            mc1_all_reports_flmfalse[i][0]['payload'].value,
                            mc1_all_reports_flmfalse[i][0]['payload'].HasField(
                                'value'
                            ),
                        ),
                        (
                            mc2_all_reports_flmtrue[i][0]['payload'].value,
                            mc2_all_reports_flmtrue[i][0]['payload'].HasField(
                                'value'
                            ),
                        ),
                        (
                            mc2_all_reports_flmfalse[i][0]['payload'].value,
                            mc2_all_reports_flmfalse[i][0]['payload'].HasField(
                                'value'
                            ),
                        ),
                    )
            ...
            asserts.assert_equal(
                [
                    (
                        (
                            mc1_all_reports_flmtrue[0][0]['payload'].value,
                            mc1_all_reports_flmtrue[0][0]['payload'].HasField(
                                'value'
                            ),
                        ),
                        # TODO: b/450553384, b/450273337, b/449684981 - This
                        # currently sometimes contains the value, even though
                        # `fetch_last_message` is false.
                        #
                        # (
                        #     mc1_all_reports_flmfalse[0][0]['payload'].value,
                        #     mc1_all_reports_flmfalse[0][0]['payload'].HasField(
                        #         'value'
                        #     ),
                        # ),
                        (
                            mc2_all_reports_flmtrue[0][0]['payload'].value,
                            mc2_all_reports_flmtrue[0][0]['payload'].HasField(
                                'value'
                            ),
                        ),
                        # TODO: b/450553384, b/450273337, b/449684981 - This
                        ...
                        #
                        # (
                        #     mc2_all_reports_flmfalse[0][0]['payload'].value,
                        #     mc2_all_reports_flmfalse[0][0]['payload'].HasField(
                        #         'value'
                        #     ),
                        # ),
                    ),
                    (
                        (
                            mc1_all_reports_flmtrue[1][0]['payload'].value,
                            mc1_all_reports_flmtrue[1][0]['payload'].HasField(
                                'value'
                            ),
                        ),
                        (
                            mc1_all_reports_flmfalse[1][0]['payload'].value,
                            mc1_all_reports_flmfalse[1][0]['payload'].HasField(
                                'value'
                            ),
                        ),
                        (
                            mc2_all_reports_flmtrue[1][0]['payload'].value,
                            mc2_all_reports_flmtrue[1][0]['payload'].HasField(
                                'value'
                            ),
                        ),
                        (
                            mc2_all_reports_flmfalse[1][0]['payload'].value,
                            mc2_all_reports_flmfalse[1][0]['payload'].HasField(
                                'value'
                            ),
                        ),
                    ),
