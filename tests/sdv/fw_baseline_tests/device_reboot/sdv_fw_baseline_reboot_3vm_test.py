...
"""SDV Three VM Reboot Test"""

from reboot_common import SdvRebootCommon
from sdv_test_fw.test_execution import sdv_base_test, sdv_test_runner


class SdvFWBaselineThreeDevicesRebootTest(
    ...
    def setup_class(self):
        ...
        self.adb_device = self.get_device('device2').adb()
        self.adb_device = self.get_device('device3').adb()
