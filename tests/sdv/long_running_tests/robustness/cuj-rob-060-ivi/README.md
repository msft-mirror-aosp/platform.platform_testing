...
# Sample: CUJ-ROB-060-IVI

## Sample

This test automates the [CUJ-ROB-060](/system/software_defined_vehicle/samples/cujs/cuj-rob-060/README.md) for an IVI device.
...
```bash
atest SdvLongRunningCujRob060IviTest
```
...
NOTIFY_AS_NATIVE=0.0.0.0:6520,0.0.0.0:6521 catbox-tradefed run commandAndExit \
    sdv-long-running-cuj-rob-060-ivi-test \
    --{device1}serial 0.0.0.0:6520 --{device2}serial 0.0.0.0:6521
```

## CI/CD execution

- Name: `sdv/long_running/cuj_rob_060_ivi`
