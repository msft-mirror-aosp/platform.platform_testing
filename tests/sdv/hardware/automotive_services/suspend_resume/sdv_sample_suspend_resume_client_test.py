...
from common_hw.arm_hardware_suspend_resume import suspend_and_resume_device, SdvQnxDevice


class SdvSampleSuspendResumeClientTest(
    ...
    def test_suspend_resume_client(self, wait_time):
        logging.info(
