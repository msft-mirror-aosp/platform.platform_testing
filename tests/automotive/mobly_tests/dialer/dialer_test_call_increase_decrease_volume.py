...
class BluetoothDialIncDecVolTest(bluetooth_base_test.BluetoothBaseTest):
    ...
    def test_call_volume(self):
      ...
      self.discoverer.mbs.openSoundPaletteOnStatusBar()
      low_sound_level = self.discoverer.mbs.setSoundLevel(0.1)
      high_sound_level = self.discoverer.mbs.setSoundLevel(0.9)
      asserts.assert_true(low_sound_level < high_sound_level, "In call volume is increased from" +str(low_sound_level) + "to" + str(high_sound_level))
      self.discoverer.mbs.openSoundPaletteOnStatusBar()
